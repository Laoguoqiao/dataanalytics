	...
	return {
		tooltip: { //弹框指示器
			...
			formatter: function(params, ticket, callback) {
				...
				var html = '<div class="commColor" style="width:100px;"><div>CurrentPrice <span  '+color+' >' + m_datas.priceArr[i] + '</span></div>';
				html += '<div>AveragePrice <span  '+color+' >' + m_datas.avgPrice[i] + '</span></div>';
				html += '<div>Gain <span  '+color+' >' + ratioCalculate(m_datas.priceArr[i],m_data.yestclose)+ '%</span></div>';
